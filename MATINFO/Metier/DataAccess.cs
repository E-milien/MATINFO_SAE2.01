...
namespace Test_WPF_SQL.Model /// A MODIFIER SI VOTRE PROJET A UN AUTRE NOM
{
    ...
    public class DataAccess
   {
      ...
      public bool OpenConnection()
      {
          try
          {
              ...
              {
                  ConnectionString = "Server=51.83.36.122;port=5432;Database=rouemi;Search Path=exemplewpf;uid=rouemi;password=dBHSdQ;" // A MODIFIER POUR VOTR BD
              };
              NpgSQLConnect.Open();
